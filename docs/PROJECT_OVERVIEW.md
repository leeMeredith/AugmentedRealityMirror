...
The source has been updated for openFrameworks 0.12.1. The JSON build compiles, its storage tests pass, and a September 24, 2026 development run showed live Kinect color and depth capture. Mirror-side switching and viewpoint movement were observed before the JSON storage change and still need a repeat check. Recording and playback checks remain open. The [original demonstration](https://vimeo.com/49252026) is historical.
