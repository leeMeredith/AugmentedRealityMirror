...
[Watch the original demonstration](https://vimeo.com/49252026) · [Read the collaboration brief](docs/COLLABORATION_BRIEF.md) · [Restore a development build](docs/BUILD.md)
...
| `docs/` | Build notes, restoration priorities, and collaboration materials |
...
For potential clinical or engineering collaborators, the [brief](docs/COLLABORATION_BRIEF.md) explains the project and the help being sought. [Vanderbilt outreach notes](docs/VANDERBILT_OUTREACH.md) contain dated contact sources and draft messages.
...
Any patient-facing evaluation should be developed with a clinical research partner, including the institution's decisions about consent, data handling, and research review. This repository supplies a prototype, not a treatment protocol.
